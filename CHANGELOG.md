...
- Channels: add Feishu/Lark channel extension with support for text, images, rich text, and quote replies.
- Providers: add Google Proxy auth option with custom baseUrl support for self-hosted Gemini endpoints.
